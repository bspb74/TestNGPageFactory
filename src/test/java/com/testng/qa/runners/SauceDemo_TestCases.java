...
public class SauceDemo_TestCases extends TestBase implements TestCaseInterface {
    ...
    @BeforeMethod
    public void setTestNameDynamically(ITestContext context, Method method) {
        String testName = method.getName() + "_" + ExtentManager.getName(context);
        context.setAttribute("testName", testName);
        log.warn("Setting Test Name: " + testName);
    }
}
